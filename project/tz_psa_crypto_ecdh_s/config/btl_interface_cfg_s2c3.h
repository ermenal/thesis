 ...
 *
 ******************************************************************************/
#ifndef BTL_INTERFACE_CFG_S2C3_H
#define BTL_INTERFACE_CFG_S2C3_H
...
// <q> EUSART2
// <i> Update secure access state of EUSART2 before calling into bootloader
#define BOOTLOADER_PPUSATD0_EUSART2 0

// <q> SYSRTC
// <i> Update secure access state of SYSRTC before calling into bootloader
#define BOOTLOADER_PPUSATD1_SYSRTC 0

// <q> LCD
// <i> Update secure access state of LCD before calling into bootloader
#define BOOTLOADER_PPUSATD1_LCD 0
...
// <q> LCDRF
// <i> Update secure access state of LCDRF before calling into bootloader
#define BOOTLOADER_PPUSATD1_LCDRF 0

// <q> PFMXPPRF
// <i> Update secure access state of PFMXPPRF before calling into bootloader
#define BOOTLOADER_PPUSATD1_PFMXPPRF 0
...
// <q> LESENSE
// <i> Update secure access state of LESENSE before calling into bootloader
#define BOOTLOADER_PPUSATD1_LESENSE 0
...
#define BOOTLOADER_PPUSATD0_MASK ((BOOTLOADER_PPUSATD0_EMU << _SMU_PPUSATD0_EMU_SHIFT)                     \
                                  ...
                                  | (BOOTLOADER_PPUSATD0_EUSART2 << _SMU_PPUSATD0_EUSART2_SHIFT))
#define BOOTLOADER_PPUSATD1_MASK ((BOOTLOADER_PPUSATD1_SYSRTC << _SMU_PPUSATD1_SYSRTC_SHIFT)         \
                                  | (BOOTLOADER_PPUSATD1_LCD << _SMU_PPUSATD1_LCD_SHIFT)             \
                                  | (BOOTLOADER_PPUSATD1_KEYSCAN << _SMU_PPUSATD1_KEYSCAN_SHIFT)     \
                                  | (BOOTLOADER_PPUSATD1_DMEM << _SMU_PPUSATD1_DMEM_SHIFT)           \
                                  | (BOOTLOADER_PPUSATD1_LCDRF << _SMU_PPUSATD1_LCDRF_SHIFT)         \
                                  | (BOOTLOADER_PPUSATD1_PFMXPPRF << _SMU_PPUSATD1_PFMXPPRF_SHIFT)   \
                                  ...
                                  | (BOOTLOADER_PPUSATD1_LESENSE << _SMU_PPUSATD1_LESENSE_SHIFT)     \
...
#endif // BTL_INTERFACE_CFG_S2C3_H
