...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/u/bin',
 'BINLIBDEST': '/u/lib/python3.10',
 'BLDLIBRARY': '-L. -lpython3.10',
 'BLDSHARED': 'gcc -pthread -shared -Wl,-rpath=\\$ORIGIN/../lib',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c99 -Wextra -Wno-unused-result '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-rpath=\\$ORIGIN/../lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/u' "
                "'LDFLAGS=-Wl,-rpath=\\$ORIGIN/../lib'",
 'CONFINCLUDEDIR': '/u/include',
 'CONFINCLUDEPY': '/u/include/python3.10',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/s/Python-3.10.5/coverage.info',
 'COVERAGE_REPORT': '/s/Python-3.10.5/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/u /u/lib /u/lib/python3.10 /u/lib/python3.10/lib-dynload',
 'DESTLIB': '/u/lib/python3.10',
 'DESTPATH': '',
 'DESTSHARED': '/u/lib/python3.10/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/u/include /u/include /u/include/python3.10 '
                   '/u/include/python3.10',
 'INCLUDEDIR': '/u/include',
 'INCLUDEPY': '/u/include/python3.10',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-rpath=\\$ORIGIN/../lib',
 'LDVERSION': '3.10',
 'LIBC': '',
 'LIBDEST': '/u/lib/python3.10',
 'LIBDIR': '/u/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/u/lib/pkgconfig',
 'LIBPL': '/u/lib/python3.10/config-3.10-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'PY_CORE_LDFLAGS': '-Wl,-rpath=\\$ORIGIN/../lib',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-rpath=\\$ORIGIN/../lib',
 'PY_LDFLAGS_NODIST': '',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/s/Python-3.10.5',
 'SCRIPTDIR': '/u/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/s/Python-3.10.5 ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/s/Python-3.10.5 ./python '
 ...
 'abs_builddir': '/s/Python-3.10.5',
 'abs_srcdir': '/s/Python-3.10.5',
 'datarootdir': '/u/share',
 'exec_prefix': '/u',
 'prefix': '/u',
 'srcdir': '.'}
