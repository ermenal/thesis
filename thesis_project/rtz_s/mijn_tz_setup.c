...
//    // NSC region 
//    SAU->RNR = i & SAU_RNR_REGION_Msk;
//    SAU->RBAR = linker_sg_begin_addr & SAU_RBAR_BADDR_Msk;
//    SAU->RLAR = (FLASH_BASE + FLASH_SIZE & SAU_RLAR_LADDR_Msk) | SAU_RLAR_ENABLE_Msk;
...
void config_smu(void) 
{
    ...
    SMU->ESAUMRB12 = (FLASH_BASE + TZ_NS_FLASH_OFFSET) & _SMU_ESAUMRB12_MASK; // Eind van NSC flash, start van NS flash
    ...
    SMU->PPUSATD0_CLR = _SMU_PPUSATD0_MASK
                        & ~(SMU_PPUSATD0_SYSCFG
                            ...
                            | SMU_PPUSATD0_LFRCO
                            | SMU_PPUSATD0_LFXO
                            // | SMU_PPUSATD0_EUSART1
                            // | SMU_PPUSATD0_EUSART2
                        );
