...
#if defined(SL_TRUSTZONE_SECURE) && defined(__ARM_FEATURE_CMSE) &&             \
...
void SMU_S_PRIVILEGED_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler")));
...
void EUSART2_RX_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler")));
void EUSART2_TX_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler")));
...
void SYSRTC_APP_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler")));
void SYSRTC_SEQ_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler")));
...
extern const tVectorEntry __VECTOR_TABLE[TOTAL_INTERRUPTS];
const tVectorEntry __VECTOR_TABLE[TOTAL_INTERRUPTS]
    __attribute__((aligned(512))) __VECTOR_TABLE_ATTRIBUTE = {
#else
extern const tVectorEntry __VECTOR_TABLE[TOTAL_INTERRUPTS];
const tVectorEntry __VECTOR_TABLE[TOTAL_INTERRUPTS] __VECTOR_TABLE_ATTRIBUTE = {
...
#endif // defined(SL_TRUSTZONE_SECURE) && defined(__ARM_FEATURE_CMSE) &&
       // (__ARM_FEATURE_CMSE == 3U)
