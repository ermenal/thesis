...
#define SL_TRUSTZONE_PERIPHERAL_CMU_S (1)

#define SL_TRUSTZONE_PERIPHERAL_DCDC_S (1)

#define SL_TRUSTZONE_PERIPHERAL_GPIO_S (1)

#define SL_TRUSTZONE_PERIPHERAL_EMU_S (1)

#define SL_TRUSTZONE_PERIPHERAL_PRS_S (1)
...
#define SL_TRUSTZONE_PERIPHERAL_LFRCO_S (1)

#define SL_TRUSTZONE_PERIPHERAL_LFXO_S (1)

#define SL_TRUSTZONE_PERIPHERAL_HFRCO0_S (1)

#define SL_TRUSTZONE_PERIPHERAL_FSRCO_S (1)
...
#define SL_TRUSTZONE_PERIPHERAL_SYSRTC_S (1)
