...
#define NONSECURE_WORLD_MARKER_VERSION    1u
#endif
...
int main(void)
{
  ...
  // print_nsc("SLOT A: SLOT B: In NS main, na boot commit\n", sizeof("SLOT A: SLOT B: In NS main, na boot commit\n") - 1);
  // print_nsc("SLOT B: SLOT B: In NS main, na boot commit\n", sizeof("SLOT B: SLOT B: In NS main, na boot commit\n") - 1);
