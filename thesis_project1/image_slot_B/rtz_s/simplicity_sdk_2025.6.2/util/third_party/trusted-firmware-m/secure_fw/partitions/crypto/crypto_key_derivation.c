...
psa_status_t tfm_crypto_key_derivation_output_key_custom(psa_invec in_vec[],
                                                  size_t in_len,
                                                  psa_outvec out_vec[],
                                                  size_t out_len)
{
...
#endif
    {
        status = psa_key_derivation_output_key_custom(&key_attributes, operation, params,
                                                       custom_data, custom_data_length, &encoded_key);
    }
...
psa_status_t tfm_crypto_key_derivation_output_key_ext(psa_invec in_vec[],
                                                  size_t in_len,
                                                  psa_outvec out_vec[],
                                                  size_t out_len)
{
...
#endif
    {
        status = psa_key_derivation_output_key_ext(&key_attributes, operation, params,
                                                       params_data_length, &encoded_key);
    }
