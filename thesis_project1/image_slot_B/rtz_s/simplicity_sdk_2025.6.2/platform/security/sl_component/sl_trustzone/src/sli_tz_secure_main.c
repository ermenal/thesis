...
int main(void)
{
  ...
  // printf("SLOT A: SLOT B: In secure main, voor init radio\n");
  // printf("SLOT B: SLOT B: In secure main, voor init radio\n");

  init_secure_radio();
  printf("SLOT B: In secure main, na init radio\n");
  // printf("SLOT A: SLOT B: In secure main, na init radio\n");
  // printf("SLOT B: SLOT B: In secure main, na init radio\n");
  start_ns_app();
