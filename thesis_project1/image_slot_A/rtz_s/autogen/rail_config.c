...
const uint32_t mijn_conf_modemConfigBase[] = {
  0x0002400CUL, 0x00000000UL,
  /*    4010 */ 0x00004000UL,
  0x00024020UL, 0x00000047UL,
  /*    4024 */ 0x00000000UL,
  ...
  /*    C0D4 */ 0x000A0001UL,
  /*    C0D8 */ 0x00280001UL,
  0x01010008UL, 0x00001744UL,
  0x01010018UL, 0x00000000UL,
  0x01010020UL, 0x00008408UL,
  0x01264040UL, 0x31900000UL,
  /*    4044 */ 0x00000000UL,
  /*    4048 */ 0x00000010UL,
  /*    404C */ 0x04000000UL,
  /*    4050 */ 0x0082C00FUL,
  ...
  0x03024FF8UL, 0x00000000UL,
  /*    4FFC */ (uint32_t) &phyInfo,
  0xFFFFFFFFUL,
};

const RAIL_ChannelConfigEntry_t mijn_conf_channels[] = {
  {
...
const RAIL_ChannelConfig_t mijn_conf_channelConfig = {
  .phyConfigBase = mijn_conf_modemConfigBase,
  .phyConfigDeltaSubtract = NULL,
  .configs = mijn_conf_channels,
  .length = 1U,
  .signature = 0UL,
...
const RAIL_ChannelConfig_t *channelConfigs[] = {
  &mijn_conf_channelConfig,
  NULL
};

uint32_t mijnAccelerationBuffer[471];
